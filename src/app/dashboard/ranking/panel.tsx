      ...
      <section className="card">
        ...
        <form className="settings-form" onSubmit={executeDryRun}>
          <div className="form-grid three">
            ...
            <div className='field'><label htmlFor='ranking-genre-id'>楽天ジャンルID（任意）</label><input id='ranking-genre-id' inputMode='numeric' pattern='[0-9]*' value={genreId} onChange={(event) => setGenreId(event.target.value)} placeholder='アカウント設定の先頭ジャンル' /><span className='field-help'>未入力なら選択アカウントの先頭ジャンルを使用</span></div>
